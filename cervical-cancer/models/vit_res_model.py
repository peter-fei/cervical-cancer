...
class VitResMoE(nn.Module):
    def __init__(self,embed_dim=512,num_classes=args.num_classes, has_logits=False,multi_tasks=args.multi_tasks,long_tail=args.long_tails,\
                alpha=args.alpha,depth=args.depth,moe_top_k=args.moe_top_k,moe_gate_dim=args.gate_dim,moe_experts=args.moe_experts,\
